...
return [
    ...
    */
    ...
    'integer'              => "':attribute' deve essere"."<br>"."un intero.",
    ...
    'max'                  => [
        'numeric' => "':attribute' non può essere"."<br>"."superiore a :max.",
        'file'    => "':attribute' non può essere più grande di :max kilobytes.",
        'string'  => "':attribute' non può essere"."<br>"."più lungo di :max caratteri.",
    ...
    'min'                  => [
        'numeric' => "':attribute' deve essere"."<br>"."almeno :min.",
        'file'    => "':attribute' deve essere almeno :min kilobyte.",
        'string'  => "':attribute' deve avere "."<br>"." almeno :min caratteri.",
        'array'   => "':attribute' deve avere almeno :min elementi.",
    ],
    'not_in'               => "':attribute' selezionato non è valido.",
    'not_regex'            => "Il formato di ':attribute' non è valido.",
    'numeric'              => "':attribute' deve"."<br>"." essere un numero.",
    ...
    'string'               => "':attribute' deve essere"."<br>"."una stringa.",
